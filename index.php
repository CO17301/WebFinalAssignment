			...
			<div class="database">
				<form method="POST" id="form_id" action="index.php">
					...
					<div class="col-75">
						<div class="colwrap">
							<div class="col-25">
									<input type="radio" name="database" value="world" onclick="databasePreview('world'); <?php if ( isset($_POST["database"]) && $_POST["database"] == "world"  ) {echo 'checked = "checked"';} ?>">World<br>
									<input type="radio" name="database" value="simpsons" onclick="databasePreview('simpsons'); <?php if (isset($_POST["database"]) && $_POST["database"] == "simpsons" ) {echo "checked";} ?>">Simpsons<br>
									<input type="radio" name="database" value="imdb_small" onclick="databasePreview('imdb_small'); <?php if (isset($_POST["database"]) && $_POST["database"] == "imdb_small" ) {echo "checked";} ?>">imdb_small<br>
									<input type="radio" onclick="databasePreview('other');" name="database" value="other" <?php if (isset($_POST["database"]) && $_POST["database"] == "other" ) {echo "checked";} ?>>other: <input style="width: 75px;"  type="text" name="othervalue"><br>
							</div>
						</div>
						<div class="colwrap">
